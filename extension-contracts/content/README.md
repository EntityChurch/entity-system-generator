...
|---|---|---|---|---|
| `typescript` | `ts-content` | 31 | yes | measured 2026-09-05 |
| `python` | `py-content` | 38 | yes | measured 2026-09-06 |
| `rust` | `rs-content` | 40 + a compile that must fail | yes, since keystone H1 (2026-09-12) | measured 2026-09-06, before H1 |
