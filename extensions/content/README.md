...
|---|---|---|---|---|
| `typescript` | `ts-content` | 31 | yes | `compositions/ts-content/status/CONFORMANCE-2026-09-05.md` |
| `python` | `py-content` | 38 | yes | `compositions/py-content/status/CONFORMANCE-2026-09-06.md` |
| `rust` | `rs-content` | 40 + a compile that must fail | **no** | `compositions/rs-content/status/CONFORMANCE-2026-09-06.md` |
