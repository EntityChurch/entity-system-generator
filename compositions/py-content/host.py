#!/usr/bin/env python3
"""py-content — the composed peer host. **The wiring program.**

The `typescript` twin is `../ts-content/host.ts`, and the two are worth diffing: the
composition-specific part is the import and the one `install_*` call, and everything else
